//The following code will validate the inputs enterd by user in singup.php

// alert("Hello");
// function validate() {
//     var pregx = /^(?:(?:\+|00)88|01)?\d{11}$/; //This line is used as regular expression to validate phone number
//     var fname = document.getElementById('fname').value;
//     var lname = document.getElementById('lname').value;
//     console.log(fname);
//     console.log(lname);
//     var email = document.forms['reg-form']['email'].value;
//     var phone = document.forms['reg-form']['phone'].value;
//     var password = document.forms['reg-form']['password'].value;
//     var repassword = document.forms['reg-form']['re-password'].value;
//     if (fname == '') {
//         alert("Hello Tushar");
//         var ferr = document.getElementById('fnameErr');
...
//     // if (phone != '' && !phone.match(pregx)) {
//     //     var perr = document.getElementById('phoneErr');
//     //     perr.innerHTML = "This isn't phone number";
//     //     perr.style.display = 'block';
//     //     perr.style.color = 'red';
//     //     return false;
//     // }
//     // if (password == '') {
//     //     var paerr = document.getElementById('passErr');
//     //     paerr.innerHTML = "Password cannot be empty";
//     //     // perr.innerHTML = "This isn't phone number";
